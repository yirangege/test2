  ...
  <el-container>
    ...
    -- <el-date-picker
      ...
      :shortcuts="shortcuts">
        ...
        <el-form-item>
          <el-button type="info" @click="getCsv" v-if="userinfo.usergroup==1">导出</el-button>
        </el-form-item>
      </el-form>
      <el-table
      ...
      >
        ...
        <el-table-column label="来源渠道" prop="fw_id" resizable width="80">
        </el-table-column>
        ...
        <div class="dialog">
          ...
          <el-form label-width="80px">
            ...
            <el-form-item label="快捷备注">
              <div class="btn-list">
                <el-button type="primary" @click="kuaijie('有效')">有效</el-button>
                <el-button type="primary" @click="kuaijie('未接')">未接</el-button>
                <el-button type="primary" @click="kuaijie('挂断')">挂断</el-button>
                <el-button type="primary" @click="kuaijie('空号')">空号</el-button>
                <el-button type="primary" @click="kuaijie('停机')">停机</el-button>
                <el-button type="primary" @click="kuaijie('关机')">关机</el-button>
                <el-button type="primary" @click="kuaijie('重复')">重复</el-button>
                <el-button type="primary" @click="kuaijie('更换咨询师')" class="mt20">更换咨询师</el-button>
              </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const Csv = reactive({
      fields: ['id','title','tel','fw_id','rv_id','uid','created','modified','remark_num','rescon'],
    });
    const getCsv = () => {
      let d = {
...
.mt20{ margin-top: 20px; margin-left: 0;}
