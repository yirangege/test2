<template>
  ...
  <el-container>
    <el-main>
      <div class="menu-btn">
    <el-button  @click="openDia" disabled="true">非展示类</el-button>
    <el-button type="info" ><router-link to="/RecycleBinZs">展示类</router-link></el-button>
  </div>
      <el-form
        :inline="true"
        :model="formInline"
          ...
          if (response.data.code == "2000") {
            try {
              ...
              if (
                ...
                link.download = `非展示类回收站${nowTime}.csv`;
